...
casper.test.begin( 'Homepage testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/homepage/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/homepage/failures' ),
	...
	casper.then( function () {
		...
		this.evaluate(function(){
			var text = document.querySelector('body > app > app-home > div > div');
			text.hidden = true;
			var input = document.querySelector('body > app > app-home > app-navmenu > div > autocomplete > form > div > input');
			input.blur();
       	});
       	this.wait(1000, function () {
       		phantomcss.screenshot("body > app > app-home > app-navmenu > div","homepage");
       	});
       	this.waitForSelector("body > app > app-home > div", function () {
       		phantomcss.screenshot("body > app > app-home > div","homepage");
       	});
       	this.waitForSelector("body > app > app-home > app-footer", function () {
       		phantomcss.screenshot("body > app > app-home > app-footer","homepage");
       	});
	} );
