...
casper.test.begin( 'Terms testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/Footer/terms/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/Footer/terms/failures' ),
		...
		this.waitForSelector("body > app > popups > div > popup-signin > div", function () {
			...
			this.waitForSelector('body > app > popups > div > popup-email-signin', function(){
				...
				this.waitFor(function() {
						...
						this.click('body > app > app-home > app-footer > div > div > ul.links > li:nth-child(1) > a');
