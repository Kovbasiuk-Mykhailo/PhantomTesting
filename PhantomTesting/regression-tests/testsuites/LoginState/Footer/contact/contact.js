...
casper.test.begin( 'Contact testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/Footer/contact/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/Footer/contact/failures' ),
		...
		this.waitForSelector("body > app > popups > div > popup-signin > div", function () {
			...
			this.waitForSelector('body > app > popups > div > popup-email-signin', function(){
				...
				this.waitFor(function() {
						...
						this.click('body > app > app-home > app-footer > div > div > ul.links > li:nth-child(2) > a');
						this.wait(2000, function() {
							phantomcss.screenshot("body > app > contact-page > div", 'contact');
							phantomcss.screenshot("body > app > contact-page > div > form:nth-child(9)", 'contact');
							phantomcss.screenshot("body > app > contact-page > div > form:nth-child(10)", 'contact');
						});
					});
			});
		});
	...
	casper.then( function () {
		this.click('body > app > app-home > app-footer > div > div > ul.links > li:nth-child(2) > a');
		casper.waitForSelector('body > app > app-home > app-footer > div > div > ul.links > li:nth-child(2) > a', function() {
				phantomcss.screenshot("body > app > app-home > app-footer > div > div > ul.links > li:nth-child(2) > a", 'contact');
		});
	});
