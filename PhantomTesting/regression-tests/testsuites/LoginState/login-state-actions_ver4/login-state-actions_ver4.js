...
casper.test.begin( 'Login-state-actions_ver4 testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/login-state-actions_ver4/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/login-state-actions_ver4/failures' ),
	...
	casper.then( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_0');
		});
	});
	casper.then( function () {
		...
		this.waitForSelector('body > app > popups > div > popup-email-signin', function(){
			...
			this.waitFor(function() {
				...
				casper.wait(5000, function() {
					phantomcss.screenshot("body", 'login-state-actions_ver4_1');
				});
			});
		});
	});
	casper.then( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_2');
		});
	});
	casper.then( function () {
		this.clickLabel('Mine boliger','a');
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_3');
		});
	});
	casper.then( function () {
		this.scrollToBottom();
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_4');
		});
		this.scrollTo(0, 0);
	});
	casper.then( function () {
		...
		this.wait(5000, function () {
			phantomcss.screenshot("body", 'login-state-actions_ver4_5');
		});
	});
	casper.then( function () {
		this.evaluate(function(){
		...
		this.wait(5000, function () {
			phantomcss.screenshot("body", 'login-state-actions_ver4_6');
		});
	});
	casper.then( function () {
		this.evaluate( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_7');
		});
	});
	casper.then( function () {
		this.evaluate( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_8');
		});
	});
	casper.then( function () {
		this.evaluate( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_9');
		});
	});
	casper.then( function () {
		this.scrollToBottom();
		this.wait(2000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver4_10');
		});
	});
