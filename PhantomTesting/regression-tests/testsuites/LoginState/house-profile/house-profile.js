...
casper.test.begin( 'House profile testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/house-profile/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/house-profile/failures' ),
	...
	casper.then( function () {
		...
		this.waitForSelector("body > app > app-search-results > div > div.main > app-search-results-list > div > ul > property-card:nth-child(1) > li > div.house_image > a > img", function() {
			this.click("body > app > app-search-results > div > div.main > app-search-results-list > div > ul > property-card:nth-child(1) > li > div.house_image > a > img");
		});
		this.waitForSelector("body > app > property > div > div > div.flex-container.singleMode > div.fi-left > div:nth-child(2) > div.expenses.flex-container > div > property-expenses > dropdown-li:nth-child(3) > div > div > h5.right > i", function() {
			this.click('body > app > property > div > div > div.flex-container.singleMode > div.fi-left > div:nth-child(2) > div.expenses.flex-container > div > property-expenses > dropdown-li:nth-child(3) > div > div > h5.right > i');
		});
		this.waitForSelector("body > app > property > div > div > div.flex-container.singleMode > div.fi-left > div:nth-child(3) > div.loans.flex-container > div > property-loans > dropdown-li:nth-child(1) > div > div > h5.right > i", function() {
			this.click('body > app > property > div > div > div.flex-container.singleMode > div.fi-left > div:nth-child(3) > div.loans.flex-container > div > property-loans > dropdown-li:nth-child(1) > div > div > h5.right > i');
		});
		...
		casper.waitForSelector('body > app > property > div > div > div.flex-container.singleMode > div.fi-left > div:nth-child(5)', function() {
			phantomcss.screenshot("body > app > property > div > div > div.flex-container.singleMode > div.fi-left > div:nth-child(5)", 'house-profile');
		}); 
