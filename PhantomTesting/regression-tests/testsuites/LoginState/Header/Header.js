...
casper.test.begin( 'header testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/Header/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/Header/failures' ),
	...
	casper.then( function () {
		...
		this.waitForSelector("body > app > app-home > app-navmenu > div > ul > li:nth-child(3) > img", function () {
