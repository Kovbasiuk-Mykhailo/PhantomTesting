...
casper.test.begin( 'Login-state-actions_ver1 testsuite', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/login-state-actions_ver1/screenshots' ),
		failedComparisonsRoot: fs.absolute( fs.workingDirectory + '/testsuites/LoginState/login-state-actions_ver1/failures' ),
	...
	casper.then( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_0');
		});
	});
	casper.then( function () {
	...
	casper.then( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_1');
		});
	});
	casper.then( function () {
		this.clickLabel('Mine boliger','a');
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_2');
		});
	});
	casper.then( function () {
		this.scrollToBottom();
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_3');
		});
		this.scrollTo(0, 0);
	});
	casper.then( function () {
		...
		this.wait(5000, function () {
			phantomcss.screenshot("body", 'login-state-actions_ver1_4');
		});
	});
	casper.then( function () {
		this.evaluate(function(){
		...
		this.wait(5000, function () {
			phantomcss.screenshot("body", 'login-state-actions_ver1_5');
		});
	});
	casper.then( function () {
		this.evaluate( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_6');
		});
	});
	casper.then( function () {
		this.evaluate( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_7');
		});
	});
	casper.then( function () {
		this.evaluate( function () {
		...
		this.wait(5000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_8');
		});
	});
	casper.then( function () {
		this.scrollToBottom();
		this.wait(2000, function() {
			phantomcss.screenshot("body", 'login-state-actions_ver1_9');
		});
	});
