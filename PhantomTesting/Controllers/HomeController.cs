...
namespace PhantomTesting.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> RunAllTests([FromServices] INodeServices nodeServices)
        {
            ...
            var testResults = Directory.EnumerateFiles(_hostingEnvironment.ContentRootPath + "/regression-tests/Reports/LoginState", "*.xml").Select(GetTestResult).ToList();
            testResults.AddRange(Directory.EnumerateFiles(_hostingEnvironment.ContentRootPath + "/regression-tests/Reports/NotLoginState", "*.xml").Select(GetTestResult));
